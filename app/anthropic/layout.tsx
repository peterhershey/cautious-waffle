...
import "../_deck/slides/principles/principles.css";
...
export const metadata: Metadata = {
  title: "Peter Hershey — for Anthropic",
  description:
    "Peter Hershey — Senior AI product designer. A short introduction for Anthropic.",
};
