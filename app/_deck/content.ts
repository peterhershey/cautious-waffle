...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    blurb:
      "Creating the interface for Google's most advanced video generation model.",
    tone: "rose",
    accent: "terracotta",
...
export const caseStudyDetails: CaseStudyDetail[] = [
  {
    id: "cs-gemini",
    slug: "teaching-gemini-to-see-deepdive",
    meta: {
    ...
    sections: [
      ...
      {
        kind: "act",
        label: "ACT I · NEW YORK · NOV 2023",
        tone: "rose",
        act: "I.",
        title: "Defining the real problem.",
        city: "nyc",
        stamp: { city: "NEW YORK", date: "NOV · 2023" },
        setup:
        ...
        imageWell: {
          caption: "Workshop wall · NYC · Nov 2023",
          aspect: "square",
        },
      },
      {
